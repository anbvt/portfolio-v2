...
```bash
npx create-next-app -e https://github.com/anbvt/portfolio-v2 your-app-name
```

```bash
npx degit anbvt/portfolio-v2 your-app-name
```
...
🧠 Made with curiosity, love, and caffeine ☕ by [Bùi Vũ Thiên Ân](https://buivuthienan.id.vn)
